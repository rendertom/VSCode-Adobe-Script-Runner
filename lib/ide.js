...
ide.config = {
	get() {
		return vscode.workspace.getConfiguration('adobeScriptRunner', ide.editor.getDocument().uri);
	},

	getWorkspaceFolder() {
		return vscode.workspace.getWorkspaceFolder(ide.editor.getDocument().uri);
	},
};
